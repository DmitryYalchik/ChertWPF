namespace ChartWpfMVVM.WpfLibrary.Interpolators
{
    public class CanvasChartFloatInterpolator : ICanvasChartInterpolator
    {
        private string formatString;

        public CanvasChartFloatInterpolator(string formatString = "F2")
        {
    ...
    public class CanvasChartIntInterpolator : ICanvasChartInterpolator
    {
        public IEnumerable<double> GetSteps(double min, double max, int noOfSteps)
        {
    ...
    /// </summary>
    public class CanvasChartIntEmptyInterpolator : CanvasChartIntInterpolator
    {
